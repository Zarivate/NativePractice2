    ...
    <SafeAreaView className="flex-1 bg-white">
      <View className="flex-1 bg-gray-100">
        ...
        <View className="flex-row items-center space-x-4 px-4 py-3 bg-white my-5">
          ...
          />
          <Text className="flex-1">Delivery time uncertain</Text>
          <TouchableOpacity>
        ...
        {/* Where all the subtotal information goes, is pushed to bottom of user screen */}
        <View className="p-5 bg-white mt-5 space-y-4">
          ...
          <View className="flex-row justify-between">
            ...
            <Text className="font-extrabold">
              <Currency quantity={userTotal + 4.99} currency="USD" />
            </Text>
          </View>

          <TouchableOpacity
            onPress={() => navigation.navigate("LoadingOrder")}
